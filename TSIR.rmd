...
_ I didn't change the parameter names in the code (I will for the paper later... I just want to get over this wall for now and be semi-formal at the same time. So $\alpha = effprop$, r is repMean,$\beta = \textrm{exp}(-R0/N)$_
