...
hmm2s <- fitHMM(data=cat1,nbStates=2,stepPar0=step0,anglePar0=angle0,
                stepDist = "lnorm", angleDist = "vm",
                formula = ~ 1)
...
hmm <- function(n,dd){
  ...
  mod <- fitHMM(data=dd,nbStates=n,stepPar0=step0,anglePar0=angle0,
                stepDist = "lnorm", angleDist = "vm",
                formula = ~ 1)
  return(mod)
}
